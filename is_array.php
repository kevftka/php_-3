...
$miCountry = ["Alemania"]; // Reemplaza esto con tu propio array
$miState = ["Belgica","Holanda"]; // Reemplaza esto con tu propio string
$miNumero = 0; // Reemplaza esto con tu propio número

echo "</br>Resultados del ejercicio:</br>";
echo '¿$miCountry es un array? ' . (is_array($miCountry) ? "Sí" : "No") . "</br>";
echo '¿$miState es un array? ' . (is_array($miState) ? "Sí" : "No") . "</br>";
