...
$misAmigos = ["Ameth","Cindy","Jacnel"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Ruben", "Jack"); // Reemplaza las comillas vacías con los nombres de tus amigos
