...
$misComidas = ["sopa", "pasta", "salsas"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["hamburguesa", "carne", "pasta de camarones"]; // Reemplaza con las comidas favoritas de tu amigo
